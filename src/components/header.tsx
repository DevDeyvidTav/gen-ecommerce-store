        ...
        <header className="bg-primary fixed z-50 justify-between px-4  pt-2 lg:px-16 text-white w-full h-16 lg:h-32 ">
            <div className="w-full lg:w-[1300px] mx-auto">
                <div className="w-full flex justify-between lg:py-4 items-center">
                    ...
                    <Link className="hidden lg:grid" href={"/"}><Image src={"/logo.jpeg"} className="hidden cursor poniter lg:flex" alt="Logo" width={70} height={20} /></Link>
                    <Image className={`${animation ? isVisible : ""} lg:hidden`} src={"/logo.jpeg"} alt="Logo" width={50} height={50} />
                    <div className="w-[40%]  hidden  text-black lg:flex items-center rounded bg-zinc-100">
                        <input
                            value={search}
                ...
                <div className="w-[40%] hidden justify-between -mt-6 lg:flex mx-auto">
