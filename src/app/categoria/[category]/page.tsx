  ...
  return (
    <div className="w-screen min-h-screen  pb-10">
      ...
      <div className="w-full 2xl:max-w-[1400px] mx-auto">
        <div className="w-4/5 mx-auto flex justify-center md:hidden items-center pt-28 lg:pt-40">
        ...
        <div
          className={`w-max lg:w-full  justify-center gap-2 lg:gap-4 mt-5 mx-auto grid ${
